...
sealed trait TextBuilder1 { self =>
  ...
  def input: TextBuilder2 = TextBuilder2(VDomBuilders.input, false)
  def textArea: TextBuilder2 = TextBuilder2(VDomBuilders.textarea, true)
